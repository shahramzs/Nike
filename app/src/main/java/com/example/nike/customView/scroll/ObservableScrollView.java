...
public class ObservableScrollView extends NestedScrollView implements Scrollable {
    ...
    @Override
    public void setScrollViewCallbacks(com.example.nike.customView.scroll.ObservableScrollViewCallbacks listener) {
        mCallbacks = listener;
    }
    ...
    @Override
    public void removeScrollViewCallbacks(com.example.nike.customView.scroll.ObservableScrollViewCallbacks listener) {
        if (mCallbackCollection != null) {
