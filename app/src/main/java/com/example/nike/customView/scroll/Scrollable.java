...
package com.example.nike.customView.scroll;
...
public interface Scrollable {
    @Deprecated
    void setScrollViewCallbacks(com.example.nike.customView.scroll.ObservableScrollViewCallbacks listener);
     ...
     * @since 1.7.0
     */
    void addScrollViewCallbacks(com.example.nike.customView.scroll.ObservableScrollViewCallbacks listener);
     ...
     * @since 1.7.0
     */
    void removeScrollViewCallbacks(com.example.nike.customView.scroll.ObservableScrollViewCallbacks listener);
